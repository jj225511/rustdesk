...
mkdir -p %{buildroot}/usr/libexec/rustdesk/
...
install $HBB/libsciter-gtk.so %{buildroot}/usr/libexec/rustdesk/libsciter-gtk.so
...
%files
/usr/bin/rustdesk
/usr/libexec/rustdesk/libsciter-gtk.so
