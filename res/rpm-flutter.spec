...
mkdir -p "%{buildroot}/usr/libexec/rustdesk" && cp -r ${HBB}/flutter/build/linux/x64/release/bundle/* -t "%{buildroot}/usr/libexec/rustdesk"
...
ln -s /usr/libexec/rustdesk/rustdesk /usr/bin/rustdesk
