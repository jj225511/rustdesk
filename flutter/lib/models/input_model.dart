...
class InputModel {
  ...
  void onPointHoverImage(PointerHoverEvent e) {
    gFFI.qualityMonitorModel.addEvents(
        '7.pointer hover:${isPhysicalMouse.value}.${kindToPrnt(e.kind)}, pos1:(${e.localPosition.dx.toStringAsFixed(0)},${e.localPosition.dy.toStringAsFixed(0)}),pos2:(${e.position.dx.toStringAsFixed(0)},${e.position.dy.toStringAsFixed(0)}),btns: ${e.buttons}');
    _stopFling = true;
  ...
  void onPointerPanZoomStart(PointerPanZoomStartEvent e) {
    gFFI.qualityMonitorModel.addEvents(
        '7.zoom start:${isPhysicalMouse.value}.${kindToPrnt(e.kind)}, pos1:(${e.localPosition.dx.toStringAsFixed(0)},${e.localPosition.dy.toStringAsFixed(0)}),pos2:(${e.position.dx.toStringAsFixed(0)},${e.position.dy.toStringAsFixed(0)}), btns: ${e.buttons}');
    _lastScale = 1.0;
    _stopFling = true;
    if (isViewOnly) return;
    if (isViewCamera) return;
  ...
  void onPointerPanZoomUpdate(PointerPanZoomUpdateEvent e) {
    gFFI.qualityMonitorModel.addEvents(
        '7.zoom update:${isPhysicalMouse.value}.${kindToPrnt(e.kind)},btns: ${e.buttons}');
    if (isViewOnly) return;
    if (isViewCamera) return;
    if (peerPlatform != kPeerPlatformAndroid) {
  ...
  void onPointerPanZoomEnd(PointerPanZoomEndEvent e) {
    gFFI.qualityMonitorModel.addEvents(
        '7.zoom end:${isPhysicalMouse.value}.${kindToPrnt(e.kind)}, btns: ${e.buttons}');
    if (isViewCamera) return;
    if (peerPlatform == kPeerPlatformAndroid) {
  ...
  void onPointDownImage(PointerDownEvent e) {
    gFFI.qualityMonitorModel.addEvents(
        '7.down:${isPhysicalMouse.value}.${kindToPrnt(e.kind)},pos1:(${e.localPosition.dx.toStringAsFixed(0)},${e.localPosition.dy.toStringAsFixed(0)}),pos2:(${e.position.dx.toStringAsFixed(0)},${e.position.dy.toStringAsFixed(0)}),btns: ${e.buttons}');
  ...
  void onPointUpImage(PointerUpEvent e) {
    gFFI.qualityMonitorModel.addEvents(
        '7.up:${isPhysicalMouse.value}.${kindToPrnt(e.kind)},pos1:(${e.localPosition.dx.toStringAsFixed(0)},${e.localPosition.dy.toStringAsFixed(0)}),pos2:(${e.position.dx.toStringAsFixed(0)},${e.position.dy.toStringAsFixed(0)}),btns: ${e.buttons}');
  ...
  void onPointMoveImage(PointerMoveEvent e) {
    gFFI.qualityMonitorModel.addEvents(
        '7.move:${isPhysicalMouse.value}.${kindToPrnt(e.kind)},pos1:(${e.localPosition.dx.toStringAsFixed(0)},${e.localPosition.dy.toStringAsFixed(0)}),pos2:(${e.position.dx.toStringAsFixed(0)},${e.position.dy.toStringAsFixed(0)}),btns: ${e.buttons}');
    // if (isViewOnly) return;
    // if (isViewCamera) return;
    // if (e.kind != ui.PointerDeviceKind.mouse) {
    //   // if (isPhysicalMouse.value) {
  ...
  void onPointerSignalImage(PointerSignalEvent e) {
    gFFI.qualityMonitorModel.addEvents(
        '7.ps:${isPhysicalMouse.value}.${kindToPrnt(e.kind)}, pos: (${e.localPosition.dx.toStringAsFixed(0)},${e.localPosition.dy.toStringAsFixed(0)}), btns: ${e.buttons}');
    // if (isViewOnly) return;
    // if (isViewCamera) return;
