...
impl PrivacyMode for PrivacyModeImpl {
    ...
    fn turn_on_privacy(&mut self, conn_id: i32) -> ResultType<bool> {
        ...
        let mut hwnd = wait_find_privacy_hwnd(1_000)?;
        if hwnd.is_null() {
            hwnd = self.start()?;
...
impl PrivacyModeImpl {
    ...
    pub fn start(&mut self) -> ResultType<HWND> {
        ...
        unsafe {
            ...
            if let Some(api_privacy_mode) = api_privacy_mode {
                log::info!("================ Start privacy window by plugin");
                ...
                log::info!("================== GetModuleHandleExA success, hinstance: {:?}, call privacy mode api", hinstance);
